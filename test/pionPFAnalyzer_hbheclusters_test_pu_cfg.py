...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/build/grimes/SLHC17_patch2+clean_shashlik_timing/step3_13839_aged_vHCalDepthClustering.root')
)
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('pionPFAnalyzer_step3_13839_aged_vHCalDepthClustering_OOT.root')
                                   )
